...
#define PARAM_ADD_CPP(TYPE, NAME, ADDRESS)                                     \
  PARAM_ADD_FULL_CPP(TYPE, NAME, ADDRESS, 0, 0)

// The callback notification function will run from the param task, it should
// not block and should run quickly.
...
#define PARAM_ADD_CORE_CPP(TYPE, NAME, ADDRESS)                                \
  PARAM_ADD_CPP(TYPE | PARAM_CORE, NAME, ADDRESS)
...
#define PARAM_GROUP_STOP_CPP(NAME)                                             \
  PARAM_ADD_GROUP_CPP(PARAM_GROUP | PARAM_STOP, stop_##NAME, 0x0)              \
  }                                                                            \
  ;
...
#define PARAM_GROUP_START(NAME)                                                \
  static struct param_s __params_##NAME[]                                      \
      __attribute__((section(".param." #NAME), used)) = {                      \
          PARAM_ADD_GROUP(PARAM_GROUP | PARAM_START, NAME, 0x0)

#define PARAM_GROUP_START_CPP(NAME)                                            \
  static struct param_s __params_##NAME[]                                      \
      __attribute__((section(".param." #NAME), used)) = {                      \
          PARAM_ADD_GROUP_CPP(PARAM_GROUP | PARAM_START, NAME, 0x0)
 ...
 *
 * The core parameters are considered part of the official API and are
