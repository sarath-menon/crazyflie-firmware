...
const char * V_SLOCAL_REVISION="153";
const char * V_SREVISION="2a700c5ff466";
const char * V_STAG="2023.02 +153";
const char * V_BRANCH="dev";
const bool V_MODIFIED=true;
const bool V_PRODUCTION_RELEASE=false;

/* Version recoverable from the ground */
const uint32_t V_REVISION_0=0x2a700c5f;
const uint16_t V_REVISION_1=0xf466;
