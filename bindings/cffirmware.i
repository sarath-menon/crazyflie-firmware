% module cffirmware % include<stdint.i>
...
#include "mm_tdoa.h"
    ...
    % include "math3d.h" % include "pptraj.h" % include "planner.h" % include "stabilizer_types.h" % include "collision_avoidance.h" % include "controller_pid.h" % include "imu_types.h" % include "controller_mellinger.h" % include "controller_brescianini.h" % include "controller_rls.h" % include "power_distribution.h" % include "axis3fSubSampler.h" % include "outlierFilterTdoa.h" % include "kalman_core.h" % include "mm_tdoa.h"

    % inline % {struct poly4d * piecewise_get(struct piecewise_traj * pp, int i){return &pp->pieces[i];
}
          ...
          % pythoncode % {
                def __repr__(self) :
                    ...
                    def __getitem__(self, i) :
                        if 0 <= i and
                i < 3 :
                            return _cffirmware.vindex(self, i) else :
